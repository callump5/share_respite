"""
Django settings for share_respite project.
...
import os
from aws import GOOGLE_RECAPTCHA_SECRET_KEY
...
SECRET_KEY = 'h&*$)qs*1^u@5n^xeu%m$h30v%e2n5sq=pau#r%q2ky4h_7dsb'
...
ROOT_URLCONF = 'share_respite.urls'
...
WSGI_APPLICATION = 'share_respite.wsgi.application'
